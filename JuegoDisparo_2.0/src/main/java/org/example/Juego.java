package org.example;//Se utiliza la importación Scanner de la biblioteca java.util para leer la entrada por consola.
...
public class Juego {
    ...
    public static void main(String[] args) {
        ...
        //Este es un comando que mantiene en espera 2 segundos y pasado el tiempo continua el resto del programa.
        try {
            Thread.sleep(2000);
        ...
        // Todos los mensajes anteriores y siguientes se muestran gracias al comando (System.out.println).
